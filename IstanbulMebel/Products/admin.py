...
class ProductAdmin(admin.ModelAdmin):
    search_fields = ('title',)
    list_display = ['title', 'category', 'manufacturer', 'color', 'discount', 'get_product_image']
    ...
    fieldsets = (
        ('Əsas Məlumatlar', {'fields': ('title', 'descriptions')}),
        ('Ətraflı Məlumatlar', {'fields': ('special_price', 'old_price', 'category', 'manufacturer', 'color', 'discount', 'stock')}),
        ('Təsvir Məlumatları', {'fields': ('text',)}),
        ('Şəkil Məlumatları', {
            'fields': (
