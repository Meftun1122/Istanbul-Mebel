...
urlpatterns = [
    ...
    path('cart/ajax/get-cart-data/', views.AjaxGetCartDataView.as_view(), name='ajax_get_cart_data'),  
    ...
    path('wishlist/ajax/get-wishlist-data/', views.AjaxGetWishlistDataView.as_view(), name='ajax_get_wishlist_data'), 
